...
\begin{center}
  \begin{tabulary}{\linewidth}{|C|C|}
    ...
    \hline
    \cd{AllTooWhile} & Versatile keyword combining the functionality of both \cd{for} and \cd{while} loops, enabling looping through code blocks in many ways. \\
    \hline
    ...
    \hline
    \cd{Then} & Used to specify an additional condition to check if the previous \cd{When} or \cd{Thats} conditions are false. If the \cd{When} or preceding \cd{Thats} conditions are false, the \cd{ThatsWhen} condition is checked, and if it's true, the associated block of code is executed. \\
    \hline
...
\begin{center}
  \begin{tabulary}{\linewidth}{|C|C|}
    ...
    \hline
    \cd{Tailor} & Imports a file of specific/appropriate format then the contents of that file will be included as part of the source code that will be executed. \\
    \cd{Def} & Used to define a function. \\
    \hline
